...
import {CloseButton, ResultTitle, ExamTitle, ExamsCard, ResultButton, ProceedButton, 
    ExamsFooter,ThisisMeButton,StartExamCard,CardText,ExamLoginImage,ExamStackPanel} from './styles';
